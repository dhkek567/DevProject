...
public class ModelMember {
	...
	public String read02(Model model) {
		...
		member1.setUserId("hongkildong");
		member1.setPassword("1234");
		member1.setEmail("ddit@n.com");
		member1.setUserName("홍길동");
		member1.setBirthDay("1888-08-08");
		...
		member1.setDateOfBirth(cal.getTime());
