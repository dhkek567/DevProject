...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			...
			<input type="hidden" name="memId" id="memId" value="${memberVO.userId}">
			<c:if test="${status eq 'u' }">
				...
				<div class="card-body">
					<div class="form-group">
						<label for="inputName">제목을 입력해주세요</label> <input type="text" id="boTitle" name="boTitle" class="form-control" value="${notice.boTitle }" placeholder="제목을 입력해주세요">
					</div>
					<div class="form-group">
			...
			<c:if test="${status eq 'u' }">
				...
				<div class="card-footer bg-white">
					<div class="row">
						<div class="col-12">
						<!-- 
							등록 일때는 목록, 등록 버튼이 나타나야 하고
							수정 일때는 수정, 취소 버튼이 나타나야함
						 -->
...
// 		var title = $("#boContent").val(); // 일반 textarea.val()를 이용해서 데이터 가져옴
