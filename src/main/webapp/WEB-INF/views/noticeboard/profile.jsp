				...
				<div class="card">
					<div class="card-header p-2">
						<ul class="nav nav-pills">
							<li class="nav-item">
							<a class="nav-link active" href="#settings" data-toggle="tab">내정보</a></li>
						</ul>
					</div>
					<div class="card-body">
							...
							<div class="tab-pane active" id="settings">
								...
								<input type="hidden" name="memNo" id="memNo" value="${member.memNo }"/>
									<div class="form-group row">
										...
										<div class="text-center">
											<img class="profile-user-img img-fluid img-circle" src="${member.memProfileImg }" id="profileImg" alt="User" style="width: 150px;">
										</div>
									</div>
									<div class="form-group row">
										<label for="memPrifileImg" class="col-sm-2 col-form-label"></label>
										<div class="col-md-10">
											<br>
									...
									<div class="input-group mb-3">
										...
										<div class="col-sm-10">
											<div class="input-group mb-3">
												<input type="text" class="form-control" value="${member.memPostCode }" name="memPostCode" placeholder="우편번호를 입력해주세요">
											...
											<div class="input-group mb-3">
												<input type="text" class="form-control" name="memAddress1" value="${member.memAddress1 }" placeholder="주소를 입력해주세요">
											</div>
											<div class="input-group mb-3">
												<input type="text" class="form-control" name="memAddress2" value="${member.memAddress2 }">
											</div>
										</div>
									</div>
									<div class="form-group row">
